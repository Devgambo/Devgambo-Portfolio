...
const experiences = [
  ...
  },
  {
    ...
    description: 'I am currently pursuing my Minors Degree in Information Technology at NITK Surathkal.',
    technologies: ['Web Technologies', 'OOPS', 'Data Structures', 'DBMS'],
    link: 'https://www.nitk.ac.in/',
    logo: '/nitk.png',
    logoAlt: 'NITK Logo',
  },
  {
    ...
    description: 'I worked as a frontend developer at onQuest and I was responsible for developing the frontend and connecting the APIs.',
